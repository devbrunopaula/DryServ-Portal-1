...
import {Row, Col, Card, CardHeader, CardTitle, CardBody, UncontrolledCollapse} from 'reactstrap';
                ...
                <Row>
                    <Col sm={12}>
                        <Card className={"iq-card"}>
                            <CardHeader className={"iq-header-title bg-white"}>
                                <span className="text-primary float-right" id="collapse1">
                                    <i className="ri-code-s-slash-line" />
                                </span>
                                <CardTitle  className={"card-title"}><h4>Display headings</h4></CardTitle>
                            </CardHeader>
                        ...
                        <Card className="iq-card">
                            ...
                            <CardBody className="iq-card-body">
                                ...
                                <UncontrolledCollapse toggler="#collapse2">
                                    <Card>
                                        <kbd className="bg-dark">
                                            <span data-copy-target="#typography" title="Copy"
                                                  data-toggle="tooltip" className="text-white float-right"
                                                  data-copy="true">
                                                Copy
                                            </span>
                        ...
                        <Card className="iq-card">
                            ...
                            <CardBody className="iq-card-body">
                                ...
                                <UncontrolledCollapse toggler="#collapse5">
                                    <Card>
                                        <kbd className="bg-dark">
                                            <span data-copy-target="#heading" title="Copy"
                                                  data-toggle="tooltip" className="text-white float-right"
                                                  data-copy="true">
                                                Copy
                                            </span>
                    ...
                    <Col sm={12}>
                        <Card className={"iq-card"}>
                            <CardHeader className={"iq-header-title bg-white"}>
                                ...
                                <CardTitle  className={"card-title"}><h4>Description list alignment</h4></CardTitle>
                            </CardHeader>
