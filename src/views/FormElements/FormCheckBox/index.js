...
<div className="checkbox d-inline-block mr-2">
<Input type="checkbox" className="checkbox-input" id="checkbox2" checked={true} />
...
<div className="checkbox d-inline-block mr-2">
<Input type="checkbox" className="checkbox-input" id="checkbox4" checked={true}
disabled="" />
...
<Label className="custom-control-label" for="customCheck5">Primary /
Inactive</Label>
</div>
<div className="custom-control custom-checkbox custom-control-inline">
<Input type="checkbox" className="custom-control-input" id="customCheck6"
checked={true} />
<Label className="custom-control-label" for="customCheck6">Primary -
active</Label>
</div>
<div className="custom-control custom-checkbox custom-control-inline">
<Input type="checkbox" className="custom-control-input" id="customCheck7"
disabled="" />
<Label className="custom-control-label" for="customCheck7">Primary -
inactive - disabled</Label>
</div>
<div className="custom-control custom-checkbox custom-control-inline">
<Input type="checkbox" className="custom-control-input" id="customCheck8" checked=""
disabled={true} />
<Label className="custom-control-label" for="customCheck8">Primary - active
- disabled</Label>
</div>
                                                `}
                                                </code>
...
for="customCheck-11">Primary </Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-success"
id="customCheck-22" />
<Label className="custom-control-label" for="customCheck-22">Success</Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-danger"
id="customCheck-33" />
<Label className="custom-control-label" for="customCheck-33">Danger</Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-warning"
id="customCheck-44" />
<Label className="custom-control-label" for="customCheck-44">Warning</Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-dark" id="customCheck-55" />
<Label className="custom-control-label" for="customCheck-55">Dark</Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-info" id="customCheck-66" />
<Label className="custom-control-label" for="customCheck-66"> Info</Label>
</div>
                                                `}
                                                </code>
                                            </pre>
...
checked={true} />
<Label className="custom-control-label" for="customCheck-t">True</Label>
</div>
<div className="custom-control custom-checkbox custom-control-inline">
<Input type="checkbox" className="custom-control-input" id="customCheck-f" />
<Label className="custom-control-label" for="customCheck-f">False</Label>
</div>
                                                `}
                                                </code>
                                            </pre>
...
<Input type="checkbox" className="custom-control-input bg-primary"
id="customCheck-1" checked={true} />
<Label className="custom-control-label" for="customCheck-1"> Primary</Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-success"
id="customCheck-2" checked={true} />
<Label className="custom-control-label" for="customCheck-2">Success</Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-danger" id="customCheck-3"
checked={true} />
<Label className="custom-control-label" for="customCheck-3">Danger</Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-warning"
id="customCheck-4" checked={true} />
<Label className="custom-control-label" for="customCheck-4">Warning</Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-dark" id="customCheck-5"
checked={true} />
<Label className="custom-control-label" for="customCheck-5">Dark</Label>
</div>
<div
className="custom-control custom-checkbox custom-checkbox-color-check custom-control-inline">
<Input type="checkbox" className="custom-control-input bg-info" id="customCheck-6"
checked={true}/>
<Label className="custom-control-label" for="customCheck-6">Info</Label>
</div>
                                                `}
                                                </code>
                                            </pre>
